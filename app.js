...
const translations = {
  ...
  "nav_origin": "品牌起源",
  "nav_market": "市场分析",
  "nav_opportunity": "合作机遇",
  "nav_contact": "联系我们",
  "nav_cta": "成为经销商",
  "hero_badge": "全球专利注册 · INPI BR 202023011705-3",
  "hero_h1a": "能听到的",
  "hero_h1b": "空气。",
  "hero_sub": "全球首款<strong>集成高端音响系统</strong>的智能变频空调 —— 开启温控与声学跨界新赛道。",
  "hero_cta1": "成为经销商",
  "hero_cta2": "探索产品",
  "stat1": "全国市场接受度",
  "stat2": "全球专利有效期",
  ...
  "stat4": "聚焦高流量B2B市场",
  "kicker_product": "创新产品",
  "h2_product": "冷暖空调。高保真音响。融为一体。",
  "lead_product": "Polar Beats 将高保真音响技术直接集成在变频壁挂式空调的侧方机身内 —— 不占用额外空间，无需繁琐线缆。",
  "cust_title": "个性化定制",
  "cust_desc": "选择您的机身外观并定义一体化 Aura 光效模式。",
  "cust_finish": "机身外观",
  "cust_aura": "Aura 光效模式",
  "sim_badge": "Polar Beats 智能声学模拟器",
  "sim_play": "听听效果",
  "sim_stop": "停止播放",
  "sim_status_stopped": "已停止",
  "sim_status_playing": "正在播放...",
  "tab_tempestade": "暴风雨",
  "tab_ninar": "摇慢曲",
  "tab_brisa: "极地微风",
  "tab_brisa": "极地微风",
  "tab_fogueira": "篝火",
  "feat1_title": "高端高保真音响",
  "feat1_desc": "侧机身高保真音频驱动单元确保 180° 超宽音场扩散 —— 声音覆盖全屋，无需外接音箱。",
  "feat2_title": "蓝牙与 Spotify 智能互联",
  "feat2_desc": "通过 Polar Beats 应用程序即可在单一面板中集中管理播放列表、温度和 Aura LED 灯光。",
  "feat3_title": "Sleep Masking 助眠遮噪模式",
  "feat3_desc: "内置算法可实时检测外部噪声，并自动播放助眠音效（雨声、白噪音、大自然）以提供极致的睡眠体验。",
  "feat3_desc": "内置算法可实时检测外部噪声，并自动播放助眠音效（雨声、白噪音、大自然）以提供极致的睡眠体验。",
  "feat4_title": "高能效智能变频温控",
  "feat4_desc": "全直流变频技术，比传统定频空调省电高达 60%，同时保持室内温度恒定舒适。",
  "feat5_title": "Aura Light 律动氛围灯",
  "feat5_desc": "内置 RGB 环形灯带可随音乐旋律流转，轻松营造工作、放松或娱乐 of 专属氛围。",
  "kicker_origin": "品牌起源",
  "h2_origin": "有些发明者放弃了他们的创意。而另一些人则选择等待最佳时机。",
  "orig1_title": "十二载的笃定坚守",
  "orig1_desc": "这个创意诞生于 12 年前。但在当时超前了 —— 市场、技术和消费需求都需要时间来走向成熟。创意曾被封存，但信念从未动摇。",
  "orig2_title": "无人触及的蓝海地带",
  "orig2_desc": "格力、美的、大金和三星等巨头几十年来在价格、冷量和能效上激烈竞争。但从未有人问过：如果空调能做更多？这个空间一直都在，只缺发现的眼睛。",
  "orig3_title": "化为现实的破局之作",
  "orig3_desc": "Polar Beats 并非在巨头的赛道中竞争，而是开辟了一个全新的品类。如今用户想要冷暖与音乐需要买两个设备，而 Polar Beats 仅凭一台专利产品完美解决。",
  "kicker_market": "选择 Polar Beats 的理由",
  "h2_market": "独立赛道。零直接竞争者。",
  "lead_market": "无论在中国还是全球市场，目前都没有任何一款产品像 Polar Beats 这样将冷暖空调与高端声学硬件完美集成并申请了专利保护。",
  "why1_title": "国家专利技术认证",
  "why1_desc": "INPI 专利有效期至 2038 年，全方位保护空调侧方集成音响的设计架构。",
  "why2_title": "即刻落地的 B2B 市场",
  "why2_desc": "诊所、健身房、酒店、美容沙龙和餐厅 —— 这些原本就需要同时配备音响和空调的高流量商业空间。",
  "why3_title": "单次投入替代双重设备",
  "why3_desc": "一次性投入，省去了分别购买和分别安装空调及专业音响系统的双重成本与繁琐流程。",
  "why4_title": "智能生态管控系统",
  "why4_desc": "自主开发的应用程序，让用户在同一个屏幕内对温度、声源和环境光效进行集中掌控。",
  "why5_title": "万亿级待开发蓝海",
  "why5_desc": "空调行业市场容量巨大。Polar Beats 作为高端破局者切入，直击消费痛点，毫无同类竞争对手。",
  "why6_title": "成熟的供应链保障",
  "why6_desc": "产品已步入最终制造阶段，拥有活跃的工业制造合作伙伴与成熟稳定的量产流程。",
  "h2_val": "数据说话。",
  "lead_val": "在全国范围内开展的概念接受度调研证实了该产品在发布前即具有极其广阔的市场空间。",
  "val_stat1": "购买意向率。该数据仅基于产品概念描述得出 —— 调研时甚至未出示实物图片或原型。",
  "val_stat2": "巴西空调市场年度总规模（估值）。",
  "val_stat3": "INPI 专利权持续受保护至 2038 年 —— 为合作伙伴保驾护航，构建坚实的法律防线。",
  "val_meta": "购买意向调研 · 巴西国家级抽样 · RT Soluções 机构执行",
  "vb1_title": "双重价值定位",
  "vb1_desc": "需要冷暖空调和背景音乐系统的客户，现在仅需一台高端产品即可一步到位满足双重需求。",
  "vb2_title": "发布前的火爆预订",
  "vb2_desc": "在概念设计阶段即已录得意向订单 —— 在实物问世前便已验证了强烈的市场需求。",
  "vb3_title": "聚焦 B2B 商业渠道",
  "vb3_desc": "精品酒店、健身房、高端诊所、美发沙龙和品质餐厅是首批重点切入的优质商业渠道。",
  "vb4_title": "全球化市场问询",
  "vb4_desc": "在概念阶段即已与美国和拉美的多位知名房地产资产及物业管理负责人展开合作接洽。",
  "kicker_opp": "致合作伙伴与投资人",
  "h2_opp": "领航未来，赢在起点。",
  "lead_opp": "Polar Beats 现正式开启针对区域核心经销商、商业渠道合作伙伴及战略投资人的首轮洽谈。",
  "opp1_title": "独家区域代理",
  "opp1_desc": "按省份或核心经济区域授予独家经营权。成为您所在市场的首位开拓者。",
  "opp2_title": "B2B 商业渠道合作",
  "opp2_desc": "直接面向高端酒店、医院诊所和大型连锁商超进行集成供应，享受超高溢价空间。",
  "opp3_title": "战略股权投资",
  "opp3_desc": "成为拥有全球专利保护及落地供应链的高科技智能硬件项目的早期投资人。",
  "opp4_title": "全球化出口业务",
  "opp4_desc": "多国及地区进口需求已确立。享有销往北美、中东和拉丁美洲等高客单价海外市场的成熟通路。",
  "patent_title": "已获全球专利保护",
  "patent_desc": "该空调侧机身集成音响系统的设计受国际专利（PCT协定）保护，并在巴西国家工业产权局（INPI）正式登记，专利号为 BR 202023011705-3，为全球市场独家专营保驾护航直至 2038 年。",
  "app_kicker": "智能掌控生态",
  "app_title": "一切尽在掌控",
  "app_desc": "通过官方的 Polar Beats 应用程序，您可以在手机、平板 ou 中控屏上集中调控室内的每一个细节 —— 轻轻一按，风速、音效及 Aura 环境氛围尽入囊中。",
  "app_feat1_title": "智能气候同步",
  "app_feat1_desc": "基于室外气象数据与用户日常偏好自动微调室内工况，提供无感知的舒适温度。",
  "app_feat2_title": "Aura 光效与音乐律动",
  "app_feat2_desc": "内置传感器采集音频频谱信息，将声音信号无延迟地转化为流光溢彩的 Aura LED 动效。",
  "app_feat3_title": "多端自适应界面",
  "app_feat3_desc": "完美兼容移动手机、各类平板以及商用智能中控屏，完美支持横竖屏无缝切换。",
  "kicker_contact": "联系我们",
  "h2_contact": "期待与您共话商机。",
  "lead_contact": "如果您是核心经销商、连锁零售商、投资人或商业空间管理者，我们诚挚邀请您进行深度探讨。",
  "cta_whats": "通过 WhatsApp 洽谈",
  "cta_email": "发送电子邮件",
  "contact_or": "或写信至",
  "f_nome": "姓名",
  "f_nome_ph": "您的姓名",
  ...
  "r_other": "其他合作类型",
  "f_email": "电子邮箱",
  "f_email_ph": "your-email@company.com",
  "f_tel": "电话 / WhatsApp",
  "f_tel_ph": "+86 130 0000 0000",
  "f_msg": "备注信息",
  "f_msg_ph": "请简要描述您的合作需求...",
  "f_send": "提交意向",
  "f_ok_title": "意向已成功登记！",
  "f_ok_desc": "非常感谢您，{name}。我们的商务代表会尽快与您取得联系。",
  "footer_meta": "Polar Beats © 2026 · 巴西 · 巴拉圭 · 专利号 BR 202023011705-3 · INPI",
  "footer_disclaimer": "概念原型。展示的设计、功能和表面工艺在未来的工业化和量产阶段可能会进行相应优化和调整。",
  "alert_fill": "请填写您的姓名、电子邮箱和电话号码。",
  "alert_err": "发送失败。请尝试通过 WhatsApp 或电子邮件直接与我们取得联系。",
  "alert_conn": "网络连接超时。请通过 WhatsApp 或直接发送邮件与我们取得联系。",
  "calc_kicker": "B2B 财务可行性分析",
  "calc_title": "评估您的商业项目能节省多少成本",
  "calc_lead": "输入您项目的房间或区域数量，评估将冷暖温控与高保真背景音响合并后能省下的设备与施工开销。",
  "calc_slider_label": "房间 / 区域数量",
  "calc_rooms_unit": "间房间",
  "calc_res1_title": "设备购置节省",
  "calc_res1_desc": "无需单独购买商业音箱、功放设备及分配器硬件。",
  "calc_res2_title": "施工成本节省",
  "calc_res2_desc": "省去音响桥架铺设、长距离走线人工及多余的墙面打孔吊装费用。",
  "calc_res3_title": "年度电费节省",
  "calc_res3_desc": "依托高效直流变频温控及音响待机智能关断算法实现长效节能。",
  "calc_total_title": "预计首年省下总成本",
  "calc_total_desc": "投资回收期短，在项目交付运营的当年即可实现回报。",
  "faq_kicker": "常见问题解答",
  "faq_title": "常见问题解答 (FAQ)",
  "faq_lead": "在这里，我们为您梳理了有关 Polar Beats 的核心技术及商业合作的常见解答。",
  "faq_q1": "集成在空调侧面的音响系统如何应对水汽冷凝及冷凝水滴漏？",
  "faq_a1": "我们专门设计并申请了音响侧腔体防潮阻隔与隔音密封专利。挂机运行产生的冷凝水通过独立密封的导水槽直接排出，与音频驱动器所在的物理腔体完全隔离，从而确保电路绝缘，提供超过15年的高稳定性使用寿命。",
  "faq_q2": "该系统是否兼容小度、天猫精灵、Google Home 或蓝牙直连？",
  "faq_a2": "当然！Polar Beats 的内置主板搭载超低延迟蓝牙 5.2 及高速 Wi-Fi 芯片。支持与市面上主流智能语音音箱配对操控，并全面兼容 Spotify Connect 以及 Apple AirPlay 进行高品质无损音频推流。",
  "faq_q3": "这台二合一设备的整机保修政策是怎样的？",
  "faq_a3": "我们提供整机 3 年的全面保修，并对核心变频压缩机提供长达 10 年的品质质保。我们的售后渠道已打通：经品牌授权的空调安装商 and 技术人员均接受过专业培训，能同时对温控及声学模块进行一站式维护。",
  "faq_q4": "Polar Beats 的技术集成专利在国际上是否受到法律保护？",
  "faq_a4: "我们的核心技术集成方案已在巴西国家工业产权局（INPI）注册，有效期至2038年。同时，我们通过PCT国际专利协定进行保护，在北美、拉美及亚洲等多个国家和地区拥有专利优先权保护屏障。",
  "faq_q4": "Polar Beats 的技术集成专利在国际上是否受到法律保护？",
  "faq_a4": "我们的核心技术集成方案已在巴西国家工业产权局（INPI）注册，有效期至2038年。同时，我们通过PCT国际专利协定进行保护，在北美、拉美及亚洲等多个国家和地区拥有专利优先权保护屏障。",
  "places_kicker": "灵活的安装适应性",
  "places_title": "一台设备，无限场景",
  "places_lead": "无需在墙面上悬挂显眼的音箱、省去长距离明线隐患，Polar Beats 是一切追求美学的高端商业及住宅建筑项目的理想之选。",
  "place1_title": "精品酒店与精品民宿",
  "place1_desc": "为高端客房提供高保真音乐与静音温控，消弭传统的管线杂乱，提升入住品质。",
  "place2_title": "婚礼沙龙与活动会馆",
  "place2_desc": "180°分布式背景声场扩散与大风量制冷，在炎炎夏日让来宾始终处于舒适优雅的环境中。",
  "place3_title": "露台烧烤与家庭影音区",
  "place3_desc": "在小型派对或晚餐聚会时，一键激活兼具温控与强劲低音的环绕声音效。",
  "place4_title": "高端诊所与心理咨询室",
  "place4_desc": "利用内置助眠算法播放白噪音进行声学隔离，保护诊室隐私并缓解候诊焦虑。",
  "place5_title": "瑜伽美体与健身工坊",
  "place5_desc": "大冷量快速制冷搭配动感音效，让均匀发散的音乐节奏带入每一次体式拉伸与力量训练。",
  "place6_title": "私宅卧房与书房影音",
  "place6_desc": "舒适的气候搭配全景声效，代替传统的挂墙音箱，还给设计极简、没有线缆的优雅空间。",
  "sim_sleep_title": "深度睡眠与白噪音模式",
  "sim_sleep_desc": "播放精选的大自然白噪音，结合特定频率以中和窗外噪声，并根据人体睡眠代谢自动微调出风温度。",
  "duo_black_desc": "拉丝石墨灰机身，配有亮眼 Aura 环形律动灯带。",
  "duo_white_desc": "极地防指纹白机身，配有亮眼 Aura 环形律动灯带。",
  "tablet_caption": "亦可通过平板电脑集中调控",
  "onde_kicker": "适合安装的场景",
  "onde_title": "一台设备，无限空间。",
  "onde_lead": "从个人住宅到五星级酒店，从品质居家到健身工坊。凡是需要温度控制与音乐点缀的物理空间，Polar Beats 均能完美适配。",
  "onde_tag_res": "品质家装",
  "onde_tag_sleep": "助眠功能",
  "onde_photo1_title": "客厅影音",
  "onde_photo1_desc": "让全家人尽享高品质温控与音乐环绕。",
  "onde_photo2_title": "厨房与社交吧台",
  "onde_photo2_desc": "在烹饪或招待朋友时，提供适宜的温度与旋律氛围。",
  "onde_photo3_title": "私享卧室",
  "onde_photo3_desc": "静音运转与大自然白噪音营造舒适入睡体验。",
  "onde_com1_title": "酒店客房",
  "onde_com1_desc": "无多余设备杂乱，为套房提供高端环绕音效及冷暖温控。",
  "onde_com2_title": "精品民宿与短租公寓",
  "onde_com2_desc": "高端科技卖点，吸引高评分并支撑更高的溢价空间。",
  "onde_com3_title": "健身与私教工作室",
  "onde_com3_desc": "180°声场确保每个角落都充满高亢节奏，搭配清爽大风量。",
  "onde_com4_title": "医疗诊所",
  "onde_com4_desc": "白噪音屏蔽接诊交谈，避免隐私泄漏，维持候诊区惬意温度。",
  "onde_com5_title": "轻奢餐厅与酒吧",
  "onde_com5_desc": "天衣无缝的背景音乐分布，无壁挂明箱，保持装修风格格调。",
  "onde_com6_title": "水疗会所与美容沙龙",
  "onde_com6_desc": "悠扬的大自然音声与恒定舒适的干爽室温，营造五感放松。",
  "onde_com7_title": "联合办公与共享会议室",
  "onde_com7_desc": "均匀新风结合低分贝白噪音，提升员工思考专注力。",
  "onde_com8_title": "品牌门店与展厅",
  "onde_com8_desc": "宜人香氛与柔和声线，增加顾客驻留时长以促成交易。",
  "amb1_title": "酒店与度假村",
  "amb1_desc": "为每间豪华套房提供隐藏式的高端音响与温控 —— 零视觉污染，五星级礼遇。",
  "amb2_title": "精品旅馆与民宿",
  "amb2_desc": "支持住客自主选择风速与音乐律动，营造私密、惬意的专属旅行回忆。",
  "amb3_title": "多功能宴会厅",
  "amb3_desc": "在大空间中提供极其均匀的风量输送与高声压背景声覆盖。",
  "amb4_title": "派对露台与社交酒吧",
  "amb4_desc": "在小酌谈天或节庆派对时提供极佳的环境音乐与凉爽体感。",
  "amb5_title": "高档私人诊所",
  "amb5_desc": "利用柔和音效及特定频率白噪音中和谈话声，保障诊间谈话隐私。",
  "amb6_title": "动感单车与瑜伽操房",
  "amb6_desc": "制冷迅速、除湿力强，配合澎湃音浪，点燃运动激情。",
  "amb7_title": "精品咖啡馆与轻食餐厅",
  "amb7_desc": "无需在墙体打孔挂吊音箱，将优雅音乐无声融入清爽冷风中。",
  "amb8_title": "董事会议室",
  "amb8_desc": "保障重要会议洽谈的私密性与高雅格调，让决策更专注。",
  "amb9_title": "豪车展厅与概念店",
  "amb9_desc": "用细节美学彰显品牌调性，让客户在舒适的环境中流连忘返。",
  "amb10_title": "皮肤管理中心",
  "amb10_desc": "静音运作搭配冥想音效，在进行面部护理时让身心重获宁静。",
  "amb11_title": "智能家居套房",
  "amb11_desc": "支持全屋智能生态联动，省去客餐厅多余的传统音箱占地。",
  "amb12_title": "多媒体阶梯教室",
  "amb12_desc": "后排学生也能清晰听到教学音频，冷气覆盖均匀不感冒。",
  "amb13_title": "神圣教堂与礼拜堂",
  "amb13_desc": "庄严 of 音声渲染与静音空气调节，构建沉静的心灵归宿。",
  "amb14_title": "智能客房",
  "amb14_desc": "住客扫码即可在手机上控制房间的冷暖与播放列表，随心所欲。",
  "amb15_title": "贵宾休息室与行政酒廊",
  "amb15_desc": "为尊贵会员提供静谧优雅的高端商旅社交及小憩港湾。",
  "amb16_title": "大堂与接待前台",
  "amb16_desc": "以柔和音乐及适宜温度在第一秒展现建筑的高端定位。",
  "amb_cta_title": "完美适配任何室内环境",
  "amb_cta_desc": "只要空间需要温度控制，即可安装 Polar Beats —— 无论是家庭住宅、商业空间、工业园区还是品质娱乐空间。一次安装，无限可能。"
}
...
const flagAssets = {
  ...
  zh: '<rect width="22" height="15" fill="#de2910"/><polygon points="4.4,1.5 4.9,3.0 6.5,3.0 5.2,4.0 5.7,5.5 4.4,4.5 3.1,5.5 3.6,4.0 2.3,3.0 3.9,3.0" fill="#ffde00"/>'
};
...
function updateCalculator() {
  ...
  if (currentLang === 'en') {
    ...
    // Convert to USD in Chinese locale
    formattedEquip = `$ ${(priceEquip / 5).toLocaleString('zh-CN', {maximumFractionDigits:0})}`;
    formattedInstall = `$ ${(priceInstall / 5).toLocaleString('zh-CN', {maximumFractionDigits:0})}`;
    formattedEnergy = `$ ${(priceEnergy / 5).toLocaleString('zh-CN', {maximumFractionDigits:0})}`;
    formattedTotal = `$ ${(priceTotal / 5).toLocaleString('zh-CN', {maximumFractionDigits:0})}`;
  } else {
    // BRL (pt)
